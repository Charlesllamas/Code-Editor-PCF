...
export class CodeEditor implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void {
        this._code = context.parameters.code.raw || undefined;
        let props: IProps = {
            code: context.parameters.code.raw || undefined,
            language: context.parameters.language.raw ?? "json",
    ...
    private notifyChange(code: string | undefined) {
        this._code = code;
